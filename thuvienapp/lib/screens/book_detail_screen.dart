...
import '../providers/api_service.dart'; // <--- 1. Import ApiService
          ...
          children: [
            ...
            Center(
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  // Hiển thị ảnh dùng Image.network + imageUrl đã xử lý
            ...
            // --- THÔNG TIN CHI TIẾT (Thể loại, NXB) ---
            ...
            Container(
              ...
              child: Text(
                widget.sach.mota ?? "Nội dung đang được cập nhật...",
